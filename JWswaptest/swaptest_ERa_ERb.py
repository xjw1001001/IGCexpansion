...
if __name__ == '__main__':
    ...
    for species1 in species1_list:
        for species2 in species2_list:
            ...
            MG94_tau = ReCodonGeneconv( newicktree, alignment_file, paralog, Model = 'MG94', Force = Force, clock = None, save_path = './save/', post_dup = 'N14')
            ...
            MG94_taus = ReCodonGeneconv( newicktree, alignment_file, paralog, Model = 'MG94', Force = Force, clock = None, save_path = './save/', post_dup = 'N14')
